...
import type { Methods as Methods0 } from './auth/token'
import type { Methods as Methods1 } from './auth/token/refresh'
import type { Methods as Methods2 } from './auth/token/verify'
import type { Methods as Methods3 } from './auth/users'
import type { Methods as Methods4 } from './auth/users/set_password'
